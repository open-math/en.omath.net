    ...
    <>
        ...
        <Problems title="Equations with a nuance..." level="example" applied>
            <SubProblem label="The Naughty Garden">
                ...
                <ProblemSolution>
                    <P>
                        Let's denote the length of the smaller side of the garden as <M>x</M> meters, then the length of
                        the larger side will be equal to <M>x + 5</M> meters. The area of the garden is equal to the
                        product of its sides, that is, we get the equation:
                    </P>
            ...
            <SubProblem label="Impatient cyclist">
                ...
                <ProblemSolution>
                    <P>
                        Let's denote the initial speed of the cyclist as <M>v</M>. The time <M>t</M> he spent on the
                        trip can be obtained by dividing the distance traveled by his speed:
                    </P>
            ...
            <SubProblem label="Picture frame">
                <ProblemDescription>
                    <P>
                        A craftsman was commissioned to make a beautiful wooden frame for a beautiful family portrait
                        measuring <M>8x10</M> inches. In order for the picture with the frame to look beautiful in a
                        closet with other things dear to the heart, its total area must be exactly <M>160</M> square
                        inches. What should be the width of the frame?
                    </P>
                ...
                <ProblemSolution>
                    <P>
                        Let's denote the desired width of the frame by the variable <M>w</M>. The picture with the frame
                        has the shape of a rectangle with sides <M>8 + 2w</M> and <M>10 + 2w</M> (<M>2w</M> because the
                        frame is on both sides of the picture). The area of a rectangle is calculated as the product of
                        its sides, that is:
                    </P>
                    ...
                    `}</BlockMath>
                    <P>
                        So for the third time we have arrived. Again a variable raised to the second power, and again it
                        is unclear what to do next!
                    </P>
                </ProblemSolution>
            </SubProblem>
        </Problems>
        ...
        <List type="ul">
            ...
            <Li>
                ...
                <P>
                    Because if <M>A = 0</M>, <M>x^2</M> multiplied by it becomes zero and disappears. And the polynomial
                    is no longer quadratic! There is no "square", that is, the second power, in it.
                </P>
            </Li>
        </List>
        ...
        >
            ...
            <Details $={uniques._equivalenceExplain} title='What does "without changing roots" mean?'>
                ...
                <P>
                    ...
                    form must occur without changing (losing or appearing) roots!
                </P>
            </Details>
        </Term>
        ...
        >
            ...
            <SubProblem>
                ...
                <ProblemCheck label="Quadratic" hint="Yes/No" answer={/yes/iu} />
                <ProblemCheck label="Coefficient A" answer={2} />
                <ProblemCheck label="Coefficient B" answer={3} />
                <ProblemCheck label="Coefficient C" answer={-5} />
                <ProblemAnswer>
                ...
                <ProblemSolution>
                    <P>
                        This equation already has the general form of a quadratic equation and therefore is quadratic.
                        Coefficients:
                    </P>
                    <BlockMath>{math`A = 2, \quad B = 3, \quad C = -5`}</BlockMath>
                </ProblemSolution>
            ...
            <SubProblem>
                ...
                <ProblemCheck label="Quadratic" hint="Yes/No" answer={/no/iu} />
                <ProblemCheck label="Coefficient A" answer={0} />
                <ProblemCheck label="Coefficient B" answer={3} />
                <ProblemCheck label="Coefficient C" answer={5} />
                <ProblemAnswer>
                ...
                <ProblemSolution>
                    <P>
                        This equation is not quadratic, since it does not have <M>x^2</M>. Strictly speaking, it can
                        still be reduced to the general form:
                    </P>
                    <BlockMath>{math`0x^2 + 3x + 5 = 0`}</BlockMath>
                    <P>
                        Coefficients: <M>A = 0</M>, <M>B = 3</M> and <M>C = 5</M>. But{' '}
                        <Dep to={uniques.quadraticEquation}>by definition</Dep> of the general form of a quadratic
                        equation, coefficient <M>A</M> cannot be equal to <M>0</M>. So this equation is not quadratic!
                    </P>
                </ProblemSolution>
            </SubProblem>
            ...
            <SubProblem>
                ...
                <ProblemCheck label="Quadratic" hint="Yes/No" answer={/yes/iu} />
                <ProblemCheck label="Coefficient A" answer={1} />
                <ProblemCheck label="Coefficient B" answer={0} />
                <ProblemCheck label="Coefficient C" answer={-4} />
                <ProblemAnswer>
                    <P>The equation is quadratic.</P>
                ...
                <ProblemSolution>
                    <P>
                        Coefficient <M>A</M> at <M>x^2</M> is <M>1</M>, since <M>x^2</M> can be written as <M>1x^2</M>.
                        Coefficient <M>B</M> at <M>x</M> is <M>0</M>, since there is no <M>x</M> in the equation, that
                        is, it can be written as <M>0x</M>. Coefficient <M>C</M> (which is alone) is <M>-4</M>.
                    </P>
            ...
            <SubProblem>
                ...
                <ProblemSolution>
                    ...
                    <P>
                        Coefficient <M>A</M> at <M>x^2</M> is <M>1</M>, since <M>x^2</M> can be written as <M>1x^2</M>.
                        Coefficient <M>B</M> at <M>x</M> is <M>0</M>, since there is no <M>x</M> in the equation, that
                        is, it can be written as <M>0x</M>. Coefficient <M>C</M> (which is alone) is <M>-5</M>.
                    </P>
                    <P>This equation is quadratic and in general form looks like this:</P>
            ...
            <SubProblem>
                ...
                <ProblemCheck label="Quadratic" hint="Yes/No" answer={/yes/iu} />
                <ProblemCheck label="Coefficient A" answer={1} />
                <ProblemCheck label="Coefficient B" answer={1} />
                <ProblemCheck label="Coefficient C" answer={0} />
                <ProblemAnswer>
                    <P>The equation is quadratic.</P>
                ...
                <ProblemSolution>
                    <P>
                        Coefficient <M>A</M> at <M>x^2</M> is <M>1</M>, since <M>x^2</M> can be written as <M>1x^2</M>.
                        Coefficient <M>B</M> at <M>x</M> is <M>1</M>, since <M>x</M> can be written as <M>1x</M>.
                        Coefficient <M>C</M> (which is alone) is <M>0</M>, since it is not in the equation at all.
                    </P>
                    <P>This equation is quadratic and in general form looks like this:</P>
            ...
            <SubProblem>
                ...
                <ProblemCheck label="Coefficient A" answer={1} />
                <ProblemCheck label="Coefficient B" answer={1} />
                <ProblemCheck label="Coefficient C" answer={-11} />
                <ProblemAnswer>
                    <P>The equation is quadratic.</P>
                ...
                <ProblemSolution>
                    ...
                    `}</BlockMath>
                    <P>
                        This equation is quadratic and we have already found its general form. Coefficient <M>A</M> at{' '}
                        <M>x^2</M> is <M>1</M>, since <M>x^2</M> can be written as <M>1x^2</M>. Coefficient <M>B</M> at{' '}
                        <M>x</M> is <M>1</M>, since <M>x</M> can be written as <M>1x</M>. Coefficient <M>C</M> (which is
                        alone) is <M>-11</M>.
                    </P>
                </ProblemSolution>
            </SubProblem>
            ...
            <SubProblem>
                ...
                <ProblemCheck label="Coefficient A" answer={1} />
                <ProblemCheck label="Coefficient B" answer={1} />
                <ProblemCheck label="Coefficient C" answer={-3} />
                <ProblemAnswer>
                    <P>The equation is quadratic.</P>
                ...
                <ProblemSolution>
                    ...
                    `}</BlockMath>
                    <P>
                        We got a quadratic equation in general form. Coefficient <M>A</M> at <M>x^2</M> is <M>1</M>.
                        Coefficient <M>B</M> at <M>x</M> is <M>1</M>. Coefficient <M>C</M> (which is alone) is <M>-3</M>
                        .
                    </P>
                </ProblemSolution>
            </SubProblem>
            ...
            <SubProblem>
                ...
                <ProblemCheck label="Quadratic" hint="Yes/No" answer={/yes/iu} />
                <ProblemCheck label="Coefficient A" answer={1} />
                <ProblemCheck label="Coefficient B" answer={-2} />
                <ProblemCheck label="Coefficient C" answer={1} />
                <ProblemAnswer>
                    <P>The equation is quadratic.</P>
                ...
                <ProblemSolution>
                    <P>
                        ...
                        <Dep to={sameActionRule}>the rule</Dep> of the same action, we multiply both sides of the
                        equation by <M>x</M>. We put the left side in brackets, since any action on the equation is{' '}
                    ...
                    <P>
                        We got a quadratic equation in general form. Coefficient <M>A</M> at <M>x^2</M> is <M>1</M>.
                        Coefficient <M>B</M> at <M>x</M> is <M>-2</M>. Coefficient <M>C</M> (which is alone) is <M>1</M>
                        .
                    </P>
                </ProblemSolution>
            </SubProblem>
            ...
            <SubProblem>
                ...
                <ProblemSolution>
                    <P>
                        On the left and right, we notice identical terms <M>x^2</M>. To get rid of them, using the same
                        action <Dep to={sameActionRule}>rule</Dep>, we subtract <M>x^2</M> from both sides of the
                        equation:
                    </P>
                    <BlockMath>{math`
                    ...
                    `}</BlockMath>
                    <P>
                        This equation is not quadratic. Strictly speaking, it can still be reduced to the general form:
                    </P>
                    <BlockMath>{math`0x^2 + 2x + 0 = 0`}</BlockMath>
                    <P>
                        Coefficients: <M>A = 0</M>, <M>B = 2</M> and <M>C = 0</M>. But{' '}
                        <Dep to={uniques.quadraticEquation}>by definition</Dep> of the general form of a quadratic
                        equation, coefficient <M>A</M> cannot be equal to <M>0</M>.
                    </P>
                </ProblemSolution>
            </SubProblem>
        </Problems>
