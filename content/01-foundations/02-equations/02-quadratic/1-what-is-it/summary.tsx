...
export default defineProse()(() => (
  <>
    ...
    <P>
      Before attempting to solve such equations, mathematicians decided to first learn how to define them and identify
      common features. To do this, they first introduced the concept of a quadratic trinomial:
    </P>
    <Include toc>{article.uniques.quadraticTrinomial}</Include>
    <P>
      If an equation can be reduced without changing roots to a form where on one side there is a quadratic trinomial,
      and on the other -- zero, then such an equation is called "quadratic".
    </P>
