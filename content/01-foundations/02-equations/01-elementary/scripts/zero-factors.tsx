    ...
    return {
        problemContent: (
            <>
                ...
                <ProblemCheck label="Equation roots" hint="Comma separated" set={[solution1, solution2]} />
                <ProblemAnswer>
                    <M>{solution1}</M> and <M>{solution2}</M>
                </ProblemAnswer>
                <ProblemSolution>
                    <P>
                        The equation can be split into two sub-equations, the goal of each is to make the corresponding
