...
export default defineProse()(() => (
  <>
    ...
    <P>
      Multiply and divide both sides carefully! Remember that these actions apply to the entire left and right sides,
      not just where it is convenient! Remember that:
    </P>
