...
// content/01-foundations/02-equations/02-quadratic/5-factoring/scripts/mental-roots.tsx
  ...
  return {
    problemContent: /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs(ProblemHint, { children: [
        "The roots are the opposites of the numbers next to ",
        /* @__PURE__ */ jsx(M, { children: "x" }),
        " in each bracket. See the full explanation in the",
        " ",
        /* @__PURE__ */ jsx(Dep, { on: {"__ERUDIT_globalContentItem":true,"__path":"foundations/equations/elementary/practice/$zeroFactors"}, children: "Zero factors" }),
        " problem."
      ] }),
